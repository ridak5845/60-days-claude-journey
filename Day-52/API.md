...
- **Response:** `200 [{ id, name, owner, private, updatedAt }]`
- **Auth:** Required.
...
- **Response:** `200 [{ number, title, author, createdAt }]`
- **Auth:** Required.
- **Errors:** `401`; `404` if repo not found/not accessible; `502` if GitHub API fails.
