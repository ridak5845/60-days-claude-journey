...
*Day 2 Deliverable, updated Day 3 with build status*

**Status legend:** ✅ built and verified · ⏳ planned, not yet built
...
│       │   ├── Dashboard.jsx        # placeholder, real repo list Day 4  ✅ (placeholder)
│       │   ├── PRList.jsx                                          ⏳ (Day 4)
...
│       ├── services/
│       │   └── api.js                                              ⏳ (Day 4 — axios currently inline in AuthContext)
│       └── styles/
