...
- A Gemini API key was inadvertently shared in plaintext via screenshot during this session on Day 3. Rotation was recommended (delete + regenerate in Google AI Studio) — **confirm this was completed before Day 5**, when Gemini is first wired into the review engine.
